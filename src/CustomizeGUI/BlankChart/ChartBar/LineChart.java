package CustomizeGUI.BlankChart.ChartBar;

import CustomizeGUI.BlankChart.BlankPlotChart;
import CustomizeGUI.BlankChart.BlankPlotChatRender;
import CustomizeGUI.BlankChart.SeriesSize;
...
public class LineChart extends javax.swing.JPanel {
    ...
    public void addLegend(String name, Color color, Color color1) {
        ...
        legends.add(data);
        pnlLegned.add(new LegendItem(data));
        pnlLegned.repaint();
        pnlLegned.revalidate();
    }
    ...
    private void initComponents() {
        ...
        pnlLegned = new javax.swing.JPanel();
        blankPlotChart = new CustomizeGUI.BlankChart.BlankPlotChart();

        setBackground(new java.awt.Color(255, 255, 255));

        pnlLegned.setOpaque(false);
        pnlLegned.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlLegned, javax.swing.GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(pnlLegned, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    }// </editor-fold>//GEN-END:initComponents

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private CustomizeGUI.BlankChart.BlankPlotChart blankPlotChart;
    private javax.swing.JPanel pnlLegned;
